...
public class QueryParser {
	...
	public QueryParameter parseQuery(String queryString) {
		...
		queryParameter.setGetFields(extractFields(queryString));
	...
	public List<AggregateFunction> extractAggregate(String queryString) {
		...
		final int selectIndex = queryString.toLowerCase().indexOf("select");
		final int fromIndex = queryString.toLowerCase().indexOf(" from");
		final String query = queryString.toLowerCase().substring(selectIndex + 7, fromIndex);
