...
public class DataMunger {
	...
	public String[] getSplitStrings(String queryString) {
		...
		queryString1 = queryString.toLowerCase();
		return queryString1.split(" ");
	}
	...
	public String getBaseQuery(String queryString) {
		String queryString1 = null;
		queryString1 = queryString.toLowerCase();
		String[] baseQuery = queryString1.split(" where | order by | group by ");
		return baseQuery[0];
	}
	...
	public String[] getFields(String queryString) {
		String queryString1 = null;
		queryString1 = queryString.toLowerCase();
		String[] getfields = queryString1.split(" from");
		String[] getfields1 = getfields[0].split("select ");
		String[] getfields2 = getfields1[1].split(" |,");
		return getfields2;
	}
	...
	public String getConditionsPartQuery(String queryString) {
		...
		String queryString1 = null;
		queryString1 = queryString.toLowerCase();
		if (queryString1.contains("where")) {
			String[] whereQuery = queryString1.split("where ");
	...
	public String[] getConditions(String queryString) {
		...
		if (queryString1.contains("where ")) {
			whereQuery = queryString1.split("where ");
			if (whereQuery[1].contains(" group by ")) {
				conditionQuery = whereQuery[1].split(" group by ");
				tempString = conditionQuery[0];
			} else if (whereQuery[1].contains(" order by ")) {
				conditionQuery = whereQuery[1].split(" order by ");
				tempString = conditionQuery[0];
			} else {
				tempString = whereQuery[1];
			}
			getCondition = tempString.toLowerCase().split(" and | or ");
			}
		return getCondition;
	} 
	...
	public String[] getLogicalOperators(String queryString) {
		String queryString1 = null;
		queryString1 = queryString.toLowerCase();
		String[] query = queryString1.split(" ");
		String getLogical = "";
		if (queryString1.contains("where ")) {
	...
	public String[] getOrderByFields(String queryString) {
		...
		if (queryString1.contains("order by")) {
			int orderby = queryString1.indexOf("order by ");
			String order = queryString1.substring(orderby + 9);
	...
	public String[] getGroupByFields(String queryString) {
		...
		String queryString1 = null;
		queryString1 = queryString.toLowerCase();
		if (queryString1.contains("group by")) {
			int groupby = queryString1.indexOf("group by");
			String group = queryString1.substring(groupby + 9);
